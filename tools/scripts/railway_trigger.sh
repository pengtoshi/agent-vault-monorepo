...
affected_projects=$(yarn nx print-affected --base="$BASE_COMMIT" --head=HEAD --select=projects --type='app')
...
do
    ...
    # get the actual value of the token from the environment variable
